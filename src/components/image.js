  ...
  return (
    <div>
      <div className="relative">
        {!inUser && !isLiked && <i className="fa fas fa-thumbs-up	absolute right-2 cursor-pointer mt-2 mr-2 hidden" 
          onClick={handleLike}></i>}
        {isLiked && <i className="fa fas fa-thumbs-down	absolute right-2 cursor-pointer mt-2 mr-2 hidden" 
